...
\begin{table}[h]
\caption{Coefficients for a polynomial preconditioner of degree $7$, $M^{-1}=s^{8}A^{7}+\cdots+s^{2}A+s^{1}I$\label{tab:polynomial-coefficients}}
\medskip{}

\begin{centering}
\begin{tabular}{cccccc}
\toprule 
 & \textbf{\scriptsize{}CEM} & \textbf{\scriptsize{}BiDiag1} & \textbf{\scriptsize{}BiDiag2} & \textbf{\scriptsize{}S1RMQ4M1} & \textbf{\scriptsize{}E20R0100}\tabularnewline
\midrule
\midrule 
